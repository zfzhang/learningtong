...
(function (b) {
    ...
    a.fn.extend({
        setup: function () {
            ...
            if (this.settings.images_links.length > 0) {
...
(function () {
    jQuery.noConflict();
    jQuery('#slideshow').skitter({ width: 1000, height: 430, animation: 'random', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a href="/"><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 2500, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
})();
