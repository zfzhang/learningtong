...
<form>
	<div class="header">
		...
		<div class="nav">
			<div class="navBox">
				...
				<div class="navSplit"></div>
				<div class="clear"></div>
				<div class="navOnDetail"><img src="<?php echo URL::base()?>images/on.png" alt="" /></div>
			</div>
		</div>
		<!-- 导航结束 -->
		<!-- Banner开始 -->
	...
	<div class="main">
		<!-- 文章开始 -->
		<div class="detail">
			<div class="detailTitle"><?php echo $v['title']?></div>
			<div class="detailSub">
				<span>来源：<?php echo $v['from']?></span>
				<span>日期：<?php echo substr($v['modified'], 0, 16)?></span>
			</div>
