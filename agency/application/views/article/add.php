				...
				<div class="content">
					...
					<div class="content-box">
						...
						<div class="content-inner">
							...
							<div class="input-box">
								<span>标题：</span><input type="text" name="title" id="title" datatype="*5-40" nullmsg="请输入标题" errormsg="请输入5-40个字的标题！" />
							</div>
							<div class="input-box">
								<span>摘要：</span><input type="text" name="remark" id="remark"  datatype="*15-60"/>
							</div>
							<div class="input-box">
								<span>来源：</span><input type="text" name="from"  id="from"  datatype="*"/>
							</div>
