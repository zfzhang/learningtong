						...
						<div class="content-inner">
							...
							<ul>
                            	<li style="width:100%">
									...
									<input id="begin_t" name="begin_str"  class="laydate-icon" datatype="*" /> 
									<label style="width:40px; text-align:center; float:left; line-height:35px;">至</label>
									<input id="end_t" name="end_str"  class="laydate-icon"  datatype="*"/>
								</li>
								<li style="width:100%">
									<span class="m-name">
										姓名：
									</span>
									<input type="text"   id="student" readonly="readonly"  datatype="*">
								...
								<li style="width: 100%;height: 100px;">
									...
									<textarea style="width: 477px;resize: none;" rows="6" name="content" id="content" datatype="*"></textarea>
								</li>
							</ul>
							</div>
