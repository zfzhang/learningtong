							...
							<table border="1" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td>
										...
										<a href="<?php echo URL::base(NULL, TRUE)?>top/publish/?id=<?php echo $v['id']?>" style="color: #F00; font-weight: bold;">发布</a>
										<?php elseif ($v['status'] == STATUS_ENABLED) : ?>
										<a href="<?php echo URL::base(NULL, TRUE)?>top/cancel/?id=<?php echo $v['id']?>" style="color: #C60; font-weight: bold;">取消</a>
										<?php endif?>
