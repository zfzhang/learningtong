						...
						<div class="content-inner">
							...
							<ul>
								<li style="width:100%">
									...
									<input type="text" style="width: 477px;" name="username" id="username" value="<?php echo $item['username']?>"  datatype="s6-18" errormsg="用户名至少6个字符,最多18个字符！"/>
								</li>
								<li style="width:100%">
									<span class="m-name">
										名称：
								...
								<li style="width:100%">
									...
									<input type="text" style="width: 477px;" name="remark" id="remark" value="<?php echo $item['remark']?>"  datatype="*"/>
								</li>
