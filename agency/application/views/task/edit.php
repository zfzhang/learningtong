					...
					<div class="content-box">
						...
						<div class="content-inner">
                            ...
                            <ul>
                                ...
                                <input class="laydate-icon inputxt" name="date_str" id="date"  datatype="*" value="<?php echo $item['date_str']?>"/>
                                </li>
                                <li>
                                ...
                                <select name="course_id" id="course" datatype="*">
									<option value=""></option>
                                ...
                                <input type="text" name="title" id="title"  datatype="*" style="width:477px"  class="inputxt"  value="<?php echo $item['title']?>" />
                                </li>
                                <li>
