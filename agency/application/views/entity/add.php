			...
			<div class="main" id="main">
				...
				<div class="content">
					...
					<div class="content-box">
						...
						<form class="registerform" method="post" id="data-form" action="<?php echo URL::base(NULL, true)?>entity/save/">
						<div class="content-inner">
							<div class="navbar-top">
								<a class="active">添加分机构</a>
							...
							<ul>
								...
								<li>
									...
									<div class="con-info">
										<input type="text" name="addr" id="addr" datatype="*"/>
									</div>
								</li>
								<li>
									<div class="con-name">
									...
									<div class="con-info">
										<input type="text" name="contact" id="contacts" datatype="*"/>
									</div>
								</li>
								<li>
									<div class="con-name">
									...
									<div class="con-info">
										<input type="text" name="mobile" id="mobile" datatype="n"/>
									</div>
								</li>
							</ul>
							<div class="btn-box">
