				...
				<div class="content">
					...
					<div class="content-box">
						...
						<div class="content-inner">
							...
							<ul>
								<li>
									<form method="post" id="data-form" action="<?php echo URL::base(NULL, true)?>show/save/" class="registerform">
									<input type="hidden" name="url" id="img_url" value="" />
									<div class="con-name">
										标题：
									</div>
									<div class="con-info">
										<input type="text" name="title" id="title" class="inputxt" datatype="*2-16" nullmsg="请输入标题！" errormsg="请输入2-16个字的标题！"/>
									</div>
									</form>
								</li>
