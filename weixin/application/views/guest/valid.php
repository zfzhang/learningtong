	...
	<body>
		...
		<div class="mui-content">
			<div class="mui-content-padded" style="margin: 10px;">
				<form method="post" id="data-form" action="<?php echo URL::base(NULL, true)?>student/auth/" class="mui-input-group">
				...
				<div class="mui-input-row" style="margin: 10px 5px;">
					<button class="mui-btn mui-btn-block bg-color" id="btnSubmit">提交</button>
				</div>
			</div>
		</div>
...
$(function () {
	...
	$('#btnSubmit').click(function () {
		...
		var url = '<?php echo URL::base(NULL, TRUE)?>guest/auth/';
