...
function promptinfo() {
	$('#province').val($('#s1').get(0).selectedIndex);
	$('#city').val($('#s2').get(0).selectedIndex);
	$('#area').val($('#s3').get(0).selectedIndex);
}

function preselect_ex(s1, s2, s3) {
	document.getElementById(s[0]).selectedIndex = s1;
    change(1);
    document.getElementById(s[1]).selectedIndex = s2;
    change(2);
    document.getElementById(s[2]).selectedIndex = s3;
}
