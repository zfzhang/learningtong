			...
			<div class="contentRight">
				...
				<div class="contentList">
					<div class="accountSettings">
						<div class="accountSettings-title">添加机构性质</div>
						<div class="accountSettings-box">
							<form class="registerform" method="post" id="data-form" action="<?php echo URL::base(NULL, true)?>agencytype/save/">
							<ul>
								<li>
                                ...
                                <li style="height: 100px;">
									...
									<textarea name="remark" id="remark" rows="4" cols="77"></textarea>
								</li>
							</ul>
							</form>
						</div>
