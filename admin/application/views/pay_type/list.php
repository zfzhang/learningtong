			...
			<div class="contentRight">
				...
				<div class="contentList">
					<div class="set-nav">
						...
						<a class="active" href="#">缴费方案</a>
						<a href="<?php echo URL::base(NULL, TRUE)?>agencytype/list/">机构性质</a>
						<a href="<?php echo URL::base(NULL, TRUE)?>servicedays/list/">缴费周期</a>
					</div>
					<div class="setting-table">
						<div class="title"><a href="<?php echo URL::base(NULL, TRUE)?>paytype/add/">增加缴费方案</a></div>
						<table border="1" cellspacing="0" cellpadding="0">
							<tr><th>序号</th><th>名称</th><th>说明</th><th>收费</th><th>操作</th></tr>
							...
							<tr>
								...
								<td><a href="<?php echo URL::base(NULL, TRUE)?>paytype/edit/?id=<?php echo $v['id']?>">编辑</td>
							</tr>
							<?php endforeach?>
						</table>
					</div>
