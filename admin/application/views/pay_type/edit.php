				...
				<div class="contentList">
					<div class="accountSettings">
						...
						<div class="accountSettings-box">
							<form class="registerform" method="post" id="data-form" action="<?php echo URL::base(NULL, true)?>paytype/save/">
							...
							<ul>
                                ...
                                <li style="height: 100px;">
									...
									<textarea name="remark" id="remark" rows="4" cols="77"><?php echo $item['remark']?></textarea>
								</li>
								<li>
									<span class="m-name">收费：
									</span>
									<input type="text" name="pay" id="pay" value="<?php echo $item['pay']?>" />
								</li>
							</ul>
							</form>
						</div>
						<div id="btnEdit" class="sendbutton">确定修改</div>
					</div>
				</div>
			</div>
		</div>
