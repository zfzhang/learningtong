			...
			<div class="contentRight">
				...
				<div class="contentList">
					<div class="set-nav">
						...
						<a class="active" href="#">缴费周期</a>
					</div>
					<div class="setting-table">
						<div class="title"><a href="<?php echo URL::base(NULL, TRUE)?>servicedays/add/">增加缴费周期</a></div>
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="<?php echo URL::base(NULL, TRUE)?>servicedays/edit/?id=<?php echo $v['id']?>">编辑</td>
							</tr>
							<?php endforeach?>
						</table>
					</div>
