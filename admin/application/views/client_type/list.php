			...
			<div class="contentRight">
				...
				<div class="contentList">
					...
					<div class="setting-table">
						<div class="title"><a href="<?php echo URL::base(NULL, TRUE)?>clienttype/add/">增加客户类型</a></div>
						<table border="1" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><a href="<?php echo URL::base(NULL, TRUE)?>clienttype/edit/?id=<?php echo $v['id']?>">编辑</td>
							</tr>
							<?php endforeach?>
						</table>
					</div>
